# Instrukcija za [[CLAUDE]] NA cPANEL-u (produkcija)

> DOPIŠI blok ispod na kraj [[CLAUDE]] u radnom folderu cPanel Claude Code-a
...
PRE SVAKOG RADA:
  ...
  (pročitaj [[PROGRESS]] i [[blokovi/BLOK-C-sledece]])
...
POSLE RADA (obavezno, ovim redom):
  ...
  3. Ako se stanje promenilo: prepiši [[PROGRESS]]
