...
- [x] #1 terasa cena — ✅ 2026-07-10 `/gumeni-podovi-za-terase-cena/` (ID 16873), M1 fallback "na upit" — kad stignu cene, upisati u tabelu → [[DNEVNIK-NAPRETKA]]
  🔄 **KONSOLIDOVANO 2026-08-18 (M odluka):** stranica je draftovana, sadržaj (cenovna tabela + FAQ) prešao u hub `/spoljnje-podne-obloge/`. Razlog: nijedna od ove 4 „cena" stranica nije postojala na live-u (sve 404), dakle 0 GSC istorije, dok hub već rangira za iste upite — objava bi uvela konkurenta stranici koja pobeđuje. → [[dnevnik/2026-08-18-konsolidacija-cenovnih-stranica]]
- [x] #2 industrijski cena — ✅ 2026-07-10 `/industrijski-podovi-cena/` (ID 16874), "na upit" + tabela po debljini sa linkovima na 500/5/7/10 info stranice; ⚠️ #ceka-M: preusmeriti Ads cena-termine (4,1k RSD curenje) na ovu landing → [[DNEVNIK-NAPRETKA]]
  🔄 **KONSOLIDOVANO 2026-08-18 (M odluka):** stranica je draftovana, sadržaj (cenovna tabela + FAQ) prešao u hub `/industrijski-podovi/`. Razlog: nijedna od ove 4 „cena" stranica nije postojala na live-u (sve 404), dakle 0 GSC istorije, dok hub već rangira za iste upite — objava bi uvela konkurenta stranici koja pobeđuje. → [[dnevnik/2026-08-18-konsolidacija-cenovnih-stranica]]
- [x] #3 garaže landing — ✅ 2026-07-10 `/podovi-za-garaze/` (ID 16875), "na upit", Pre/Posle ecotile fotke, diferencirana od `/industrijski-podovi/garaze-i-autoservisi/` (cross-link); ⚠️ #ceka-M: Ads garaža-termini (16,8k RSD išlo u prazno) → ova landing → [[DNEVNIK-NAPRETKA]]
  🔄 **KONSOLIDOVANO 2026-08-18 (M odluka):** stranica je draftovana, sadržaj (cenovna tabela + FAQ) prešao u hub `/industrijski-podovi/garaze-i-autoservisi/`. Razlog: nijedna od ove 4 „cena" stranica nije postojala na live-u (sve 404), dakle 0 GSC istorije, dok hub već rangira za iste upite — objava bi uvela konkurenta stranici koja pobeđuje. → [[dnevnik/2026-08-18-konsolidacija-cenovnih-stranica]]
...
- [x] #6 parking cena — ✅ 2026-07-10 `/podloge-za-parkiraliste-cena/` (ID 16876) — **sa PRAVIM cenama** (Runfloor 2.800–3.400, Geoflor 3.400, Geogravel 4.000, Geocross 4.200 din/m² sa PDV; nosivosti 600/400/100 t/m² — izvor: hub 16589 parity sadržaj, draft je pogrešno pretpostavljao 200 t/m²) → [[DNEVNIK-NAPRETKA]]
  🔄 **KONSOLIDOVANO 2026-08-18 (M odluka):** stranica je draftovana, sadržaj (cenovna tabela + FAQ) prešao u hub `/podloge-za-parkiraliste-i-staze/` (hub je taj sadržaj već imao — ništa nije prenošeno). Razlog: nijedna od ove 4 „cena" stranica nije postojala na live-u (sve 404), dakle 0 GSC istorije, dok hub već rangira za iste upite — objava bi uvela konkurenta stranici koja pobeđuje. → [[dnevnik/2026-08-18-konsolidacija-cenovnih-stranica]]
