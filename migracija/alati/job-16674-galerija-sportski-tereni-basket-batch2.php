<?php
// W1 BLOK E — Galerija sportskih terena (16674) — batch 2: 6 dodatnih
// ranije nekorišćenih terena iz "tereni za basket" ZIP arhive.
...
$photos = [
    [
        'src' => $src_dir . 'Bergo multisport - Vrcin.jpg',
        'dest' => 'bergo-multisport-teren-vrcin.jpg',
        'alt' => 'Bergo multisport teren, Vrčin',
        'title' => 'Vrčin',
    ],
    [
        'src' => $src_dir . 'Teren 3x3 - Kanjiza.jpg',
        'dest' => 'teren-3x3-kanjiza.jpg',
        'alt' => '3x3 košarkaški teren, Kanjiža',
        'title' => 'Kanjiža',
    ],
    [
        'src' => $src_dir . 'teren za ogradom Barajevo.jpg',
        'dest' => 'teren-za-basket-barajevo.jpg',
        'alt' => 'Teren za basket, Barajevo',
        'title' => 'Barajevo',
    ],
    [
        'src' => $src_dir . 'Teren 3x3 - Drinska bajka Bajina Basta.jpg',
        'dest' => 'teren-3x3-bajina-basta.jpg',
        'alt' => '3x3 košarkaški teren, Bajina Bašta (Drinska bajka)',
        'title' => 'Bajina Bašta',
    ],
    [
        'src' => $src_dir . 'Teren 3x3 - Irig.jpg',
        'dest' => 'teren-3x3-irig.jpg',
        'alt' => '3x3 košarkaški teren, Irig',
        'title' => 'Irig',
    ],
    [
        'src' => $src_dir . 'Coca Cola, Dobanovci.jpg',
        'dest' => 'teren-za-basket-coca-cola-dobanovci.jpg',
        'alt' => 'Teren za basket, Coca-Cola Dobanovci',
        'title' => 'Coca-Cola, Dobanovci',
    ],
];
