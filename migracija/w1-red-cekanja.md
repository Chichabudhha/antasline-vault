...
**Top prioritet za sledeću W1 sesiju:** #6 podovi-za-bazene (262), #7 iznajmljivanje-podova (232), #8 garaze-i-autoservisi (229, F6 troslojni kandidat). (#1 antistatik, #2 bergo-xl, #3 kosarkaske-konstrukcije, #4 Ecotile 500/7, #5 Naxos sale-i-balone ✅ svi gotovi.)
