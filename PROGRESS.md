...
2. **W1 1.2 red čekanja** — ✅ #1 antistatik, #2 bergo-xl, #4 Ecotile 500/7, #5 Naxos sale-i-balone zatvoreni → [[migracija/w1-red-cekanja]]. Sledeći: #6 podovi-za-bazene (262 kl.), #7 iznajmljivanje-podova (232 kl.). Otkriven legacy `spoljne-podne-obloge` CPT sa još 5 Bergo modela (unique/elite/solid/flow + 2 draft) — koristi kao izvor pri budućim rebuild-ovima #9/#22/#25.
