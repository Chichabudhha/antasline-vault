...
- 🟢 **ODLUČENO 2026-08-17 (M) — preostalih 14 proizvoda bez fotografije ide u `draft`.** Izvršenje u sledećoj sesiji (M: „akciju radimo u sledećoj sesiji”), rok **ČET 20.08** (novi freeze). Pri izvršenju: backup baze, pa provera da nijedan interni link ni ijedno od 73 `.htaccess` pravila ne gađa te URL-ove (draft = 404). → [[odluke/_pregled-odluka]] #claude-code
...
- 🟢 **ODLUČENO 2026-08-17 (M) — stari meni term 67 se BRIŠE.** Nov meni ostaje term **390**. Izvršenje u sledećoj sesiji uz backup baze (nepovratno na nivou baze), rok **ČET 20.08**. → [[odluke/_pregled-odluka]] #claude-code
...
- 🟢 **ODLUČENO 2026-08-17 (M) — 4 modela (Highlands/Nature/Put/Springgrass) vezuju se za `Radici Landscape`**, ne prave se novi proizvodi (izbegava 4 prazne kartice, ista logika kao odluka o draftu). Kartice sada vode na kategoriju → prevezati na proizvod. Izvršenje u sledećoj sesiji, rok **ČET 20.08**. → [[odluke/_pregled-odluka]] #claude-code
