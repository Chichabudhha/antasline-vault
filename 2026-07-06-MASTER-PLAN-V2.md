...
| 2.8 | ✅ POTPUNO ZATVORENO 2026-08-11 — GEO paket: `llms.txt` kreiran (07-08) + Organization proširen na LocalBusiness+NAP (filter, sitewide). "O nama" bio već gotov od ranije. `robots.txt` na live-u aktiviran `[cpanel-live]` 2026-08-11 (M dodao 9 AI-crawler pravila, provera otkrila i ispravila dupli `User-agent: *` blok + charset mojibake). Preostaje samo PR/GMB deo (van SEO/tehničkog obima) | CC+M | — |
