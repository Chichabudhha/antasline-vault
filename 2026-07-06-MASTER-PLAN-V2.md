...
| 4.9 | Faza 4: call asset 072, mobilni bid +15–20%, publike u Observation, Customer Match (email-ovi iz upita) | M+CC | zaobilazi prag publika — 🔴 Customer Match deo 2026-08-07: pipeline testiran end-to-end na cPanel-u (2 koda-bug-a popravljena), audience lista uspešno kreirana u pravom nalogu, ali stvaran upload BLOKIRAN — Basic developer token ne pokriva Customer Match (`CUSTOMER_NOT_ALLOWLISTED_FOR_THIS_FEATURE`). #ceka-miroslav: Standard access u Ads API Center (v. PROGRESS) |
