...
> 🆕 **2026-08-18 — istraživanje sekcije „Industrijski podovi" + ESD (ad-hoc, post-live materijal).**
> → [[seo/2026-08-18-istrazivanje-industrijski-podovi-esd]] · [[dnevnik/2026-08-18-istrazivanje-industrijski-podovi-esd]]
> Ništa nije menjano na buildu. Iz istraživanja izlaze **tri kandidata za red čekanja posle
> 25.08**: (1) nova **`/podovi-za-radionice/`** — zbir varijanti nosi **~4.700 prikaza /
> ~275 klikova, poz. 3,5–7, bez namenske stranice** (više kvalifikovane tražnje nego ceo
> Ecotile-PVC klaster); (2) **cenovni blok + `cena po m2` odgovor** na `/industrijski-podovi/`
> — ~1.800 prikaza čistog cenovnog intenta stoji neopsluženo, dok kontrolni `antistatik pod
...
| 3.10d | ✅ **REGRESSION SWEEP PONOVLJEN 2026-08-19, dan PRE novog freeze-a** — baseline 13.08 je pao prvom sadržajnom izmenom 18.08 (konsolidacija cenovnih stranica, ESD klaster, stavka F), a 19.08 je dodata i izmena na 16687. Sweep pušten **namerno dan ranije**, ne 20.08 uveče, da ostane vreme za popravku pre gate-a 21.08. **235 stranica · 1.174 slike · 1.799 linkova: 0 non-200 · 0 bez H1 · 0×2H1 · 0 nevalidan JSON-LD · 0 slomljenih slika · 0 internih 404.** Bez metadesc **18** (bilo 31) — ostale su samo `product_tag` arhive, posle live-a. **Diff vs 13.08: 30 URL promena (13 novih / 17 nestalih) + 18 izmena title/meta — svaka vezana za dokumentovanu odluku, nula neplaniranih.** 🔵 Četiri nestala URL-a nisu bila objašnjiva iz `PROGRESS`-a (17025 · 16683 · 2622 · 16665) — provereno pojedinačno: sva četiri `draft` **i** pokrivena 301 pravilom; uzrok je što su konsolidacione skripte 13.08 radile **posle** generisanja baseline CSV-a (15:47–18:35 vs snimak 17:24). **301 mapa reverifikovana** istom sesijom: **80 pravila · 43 jedinstvena cilja svi 200 · 0 duplikata · 0 petlji · 0 kolizija sa živim stranicama**; upozorenje za 16613 iz provere 13.08 više se ne javlja (stranica draftovana, slug swap izveden). Uslovni izuzetak od 18.08 proveren u bazi: **16875 i dalje `draft`** → pravilo `/podovi-za-garaze/` (182 GSC pogotka) ispravno stoji. **Nov baseline za §B6: `analiza/2026-08-19-regression-pre-freeze-*`.** → [[dnevnik/2026-08-19-regression-sweep-pre-freeze]] | CC | zamenjuje 13.08 baseline · posle freeze-a 20.08 ostaje samo brz potvrdni sweep + nov backup builda |
