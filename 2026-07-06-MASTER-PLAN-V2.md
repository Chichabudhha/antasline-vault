...
| 1.12 | ✅ ZATVORENO 2026-07-11 — **Court builder 2D** (`/planer-terena/`, samo Bergo Ultimate 16770 + FLOW 16801): SVG dizajner sa sport šablonima, obračun ploča/rampi/opreme, zaključan dizajn u WP adminu, mejl klijentu PNG+PDF (bez edit linka), token-link za novu verziju, cene → automatski predračun. CB1+CB2+CB3 sve zatvorene, testirano end-to-end kroz Chrome (3 puna ciklusa + bezbednosni testovi: honeypot/rate-limit/PNG+grid validacija). Faze → **[[migracija/w1-novi-proizvodi-court-builder]]** | CC | ⚠️ Preostaje: SMTP konfiguracija na live pre javnog puštanja (lokalno mail-log.php presreće slanje, mora se ukloniti na produkciji — u 3.10 checklisti). 3D varijanta EKSPLICITNO posle live-a (W6+ era, van V2 obima) |
